...
class HarmonizeSloleks(Block):
    """Upload harmonized trees of Sloleks to format of Derinet."""
    ...
    def process(self, lexicon: Lexicon):
        """Build Slovenian Sloleks to DeriNet format."""
        # load data
        harm = pickle.load(open(self.fname, 'rb'))
        parse_pos = {
            'V': 'VERB', 'N': 'NOUN', 'A': 'ADJ', 'D': 'ADV', 'R': 'PRON',
            'I': 'INTJ', 'U': 'NUM', 'P': 'ADP', 'C': 'CONJ', 'K': 'PART',
            'E': 'X', 'L': 'X'
        }
