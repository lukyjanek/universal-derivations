...
UDer-collection:
	...
	# pre-prepared: (need to annotate and harmonize automatically)
...
# Build particular UDer resource; arguments: version, language, resource
UDer-resource:
...
# Calculate statistics for each resource in UDer collection
UDer-statistics:
